...
Scenario: Registrering med personnummerbugg
    Givet en kund med förnamnet "Test", efternamnet "Testsson", personnumret "1212-121212", som bor på gatan "Testgatan 55" med postnummer "12345" och orten "Testort", har telefonnumret "s08-123456", mobilnumret "073-123456", mejladressen "test@test.com" och använder lösenordet "123456".
