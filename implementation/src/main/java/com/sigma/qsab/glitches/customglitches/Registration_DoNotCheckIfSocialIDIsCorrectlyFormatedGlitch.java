...
public class Registration_DoNotCheckIfSocialIDIsCorrectlyFormatedGlitch extends Glitch {
    ...
    public Registration_DoNotCheckIfSocialIDIsCorrectlyFormatedGlitch() {
